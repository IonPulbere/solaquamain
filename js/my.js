...
//decline cookies
  ...
  $('#responsive-nav a,.getbutt a,.s-solar-electric a,#c-p,#p-p,.link-p-c a').on('click', function(e) {
    e.preventDefault();
    var href = this.href;
    var $this = $(this);
    loadContent(href);
    ...
    document.querySelector("title").textContent=("SOLAQUA | "+(this.textContent)).toUpperCase();
